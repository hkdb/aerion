<script lang="ts">
  ...
  async function handleEditDraft(draftId: string) {
    ...
    const accountId =
      ...
      selectedAccountId ||
      accountStore.accounts[0]?.account.id;
  ...
  <div class="flex flex-1 min-h-0 overflow-hidden relative">
    ...
    <aside
      class={getLayoutMode() === "narrow"
        ? `responsive-sidebar-overlay w-72 border-r border-border bg-background ${getResponsiveView() === "sidebar" ? "responsive-sidebar-visible" : ""}`
    ...
    <section
      ...
      class={isResponsive()
        ? "flex-1 min-w-0 border-r border-border bg-background"
  ...
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
    <div
      class={getLayoutMode() === "narrow"
        ...
        : "w-full max-w-3xl h-[80vh] bg-background rounded-lg shadow-xl overflow-hidden"}
    >
      <Composer
