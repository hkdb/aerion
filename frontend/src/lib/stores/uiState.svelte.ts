    ...
    if (state) {
      ...
      currentState = {
        ...
        selectedConversationAccountId:
          state.selectedConversationAccountId || null,
        selectedConversationFolderId:
          state.selectedConversationFolderId || null,
...
export function saveUIState(updates: Partial<UIState>): void {
  ...
  if (updates.sidebarWidth !== undefined) {
    currentState.sidebarWidth = clamp(
  ...
  saveTimer = setTimeout(async () => {
    try {
      ...
      const backendState: appstate.UIState = {
        ...
        selectedConversationAccountId:
          currentState.selectedConversationAccountId || "",
        selectedConversationFolderId:
          currentState.selectedConversationFolderId || "",
